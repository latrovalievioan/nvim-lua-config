...
-- Remove lspconfig.util dependency since we're using native LSP
local lsp = vim.lsp
...
return {
  ...
  root_dir = function(bufnr, on_dir)
    ...
    local eslint_config_files_with_package_json = vim.list_extend(
      vim.deepcopy(eslint_config_files),
      { 'package.json' }
    )
